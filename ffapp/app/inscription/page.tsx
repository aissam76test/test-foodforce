...
export default function Inscription(){
 ...
 async function signup(e:FormEvent){e.preventDefault();setMessage("Création du compte…");const s=createClient();const {data,error}=await s.auth.signUp({email,password,options:{data:{role,full_name:name,city}}});if(error){setMessage(error.message);return;}setMessage("Compte créé. Vérifiez votre email si une confirmation est demandée.");}
