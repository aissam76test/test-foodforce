...
export default function Inscription() {
  ...
  const [autoNumber,setAutoNumber]=useState(""); const [experience,setExperience]=useState("");
  ...
  async function signup(e:FormEvent){
    ...
    const {data,error}=await s.auth.signUp({email,password,options:{data:{
      ...
      auto_entrepreneur_number:role==="extra"?autoNumber:null,experience:role==="extra"?experience:null
    }}});
