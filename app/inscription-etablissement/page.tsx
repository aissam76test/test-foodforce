...
export default function InscriptionEtablissement() {
  ...
  if (sent) return (
    <div style={{ textAlign: 'center', padding: '100px 40px', fontFamily: 'Poppins, sans-serif' }}>
      ...
      <h1 style={{ fontSize: '32px', fontWeight: 800, color: '#1a1a1a', margin: '20px 0 10px' }}>Compte créé !</h1>
      <p style={{ color: '#666' }}>Bienvenue sur FoodForce. <a href="/login" style={{ color: '#F47C20', fontWeight: 600 }}>Se connecter</a></p>
    </div>
  );
  ...
  return (
    <main style={{ fontFamily: 'Poppins, sans-serif', background: '#FDF0E8', minHeight: '100vh', padding: '60px 20px' }}>
      <div style={{ maxWidth: '500px', margin: '0 auto', background: 'white', borderRadius: '20px', padding: '40px', boxShadow: '0 4px 30px rgba(0,0,0,0.08)' }}>
        ...
        <h1 style={{ fontSize: '24px', fontWeight: 800, marginBottom: '4px', textAlign: 'center' }}>Créer un compte recruteur</h1>
        ...
        {etape === 2 && (
          <form onSubmit={handleSubmit}>
            ...
            <p style={{ fontSize: '13px', color: '#888', marginBottom: '24px' }}>Renseignez les informations de votre établissement</p>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <button type="submit" disabled={loading}
                style={{ flex: 2, background: '#F47C20', color: 'white', padding: '16px', borderRadius: '10px', border: 'none', fontSize: '15px', fontWeight: 700, cursor: 'pointer', opacity: loading ? 0.7 : 1 }}>
